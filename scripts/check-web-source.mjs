...
if (!caddy.includes('@runtime') || !/@runtime[\s\S]*?reverse_proxy 127\.0\.0\.1:8090/.test(caddy)) throw new Error('machine telemetry must keep its dedicated Bearer route ahead of the catch-all proxy')
