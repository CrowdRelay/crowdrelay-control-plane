...
function NavIcon(props: { name: string }) {
  const icons: Record<string, any> = {
    ...
    target: <><rect x="3" y="4" width="4" height="4" rx="1" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M4 6l1 1l2-2" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 6h11" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><rect x="3" y="15" width="4" height="4" rx="1" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M10 17h11" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></>,
  }
