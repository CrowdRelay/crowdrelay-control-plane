  ...
  >
    ...
    <g class="flow-node flow-node-source">
      ...
      <g transform="translate(44 216)" class="flow-source-icons">
        ...
        {/* SoundCloud — simplified waveform bars + cloud bump. The full
            simple-icons path has 30+ segments that render as a blob at
            30px; this reads as SoundCloud at any size. */}
        <svg x="123" y="74" width="30" height="30" viewBox="0 0 24 24" fill="#FF5500" aria-hidden="true">
          <rect x="1" y="11" width="1.4" height="6" rx="0.5"/>
          <rect x="3.2" y="9" width="1.4" height="8" rx="0.5"/>
          <rect x="5.4" y="7" width="1.4" height="10" rx="0.5"/>
          <rect x="7.6" y="8.5" width="1.4" height="8.5" rx="0.5"/>
          <rect x="9.8" y="6" width="1.4" height="11" rx="0.5"/>
          <rect x="12" y="5" width="1.4" height="12" rx="0.5"/>
          <path d="M14.2 18V8.5C15 7.6 16.2 7 17.5 7c2.5 0 4.5 2 4.5 4.5 0 .3 0 .6-.1.8.6.3 1 1 1 1.7 0 1.1-.9 2-2 2H14.2z"/>
        </svg>
      </g>
    </g>
