...
const FlowDiagram: Component = () => {
  ...
  >
    ...
    <g class="flow-node flow-node-brain">
      ...
      <g transform="translate(350 235)" class="flow-brain-icon" style={{ color: 'var(--accent-light)' }}>
        <BrainIcon size={80} />
      </g>
    </g>
    ...
    <g class="flow-node flow-node-worker">
      ...
      <g transform="translate(620 235)" class="flow-worker-icon" fill="none" style={{ stroke: 'var(--accent-light)' }} stroke-width="2" stroke-linejoin="round">
    ...
    <g class="flow-node flow-node-outcome">
      ...
      <g transform="translate(890 240)" class="flow-outcome-icon" fill="none" style={{ stroke: 'var(--accent-light)' }} stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
